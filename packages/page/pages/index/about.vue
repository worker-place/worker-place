...
<template>
  <Container article max>
    <Container padded>
      ...
      <Text>
        Originally, the challenge had a very short deadline of just one week. We set out to create a place where squads can compete to draw their desired image in our <Text italic part>
          place
        </Text>.
      </Text>
      <Text>
